...
class MistralInterceptor(BaseInterceptor):
    """Intercept Mistral chat completions."""
    ...
    def patch(self) -> None:
        ...
        try:
            from mistralai.resources.chat.completions import AsyncCompletions, Completions
        except ImportError:
            warn_missing_sdk("mistral", "mistral", "mistralai")
            return
        ...
        def patched_create(self_sdk: Any, *args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                cost = calculate_cost("mistral", model, tokens)

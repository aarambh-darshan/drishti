...
def _instrument_sync_stream(stream_obj: Any, span: Span, model: str, messages: Any):
    usage_tokens = TokenUsage()
    output_parts: list[str] = []
    completed = False
...
async def _instrument_async_stream(stream_obj: Any, span: Span, model: str, messages: Any):
    usage_tokens = TokenUsage()
    output_parts: list[str] = []
    completed = False
...
class GroqInterceptor(BaseInterceptor):
    ...
    def patch(self) -> None:
        ...
        try:
            ...
            warn_missing_sdk("groq", "groq", "groq")
            return
        ...
        def patched_create(self_sdk: Any, *args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                if is_stream:
                    return _instrument_sync_stream(response, span, model, messages)
        ...
        async def async_patched_create(self_sdk: Any, *args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                if is_stream:
                    return _instrument_async_stream(response, span, model, messages)
